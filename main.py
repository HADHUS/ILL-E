...
def fish():
  ...
  if "ultra rod" in inventory:
    fishtop = 100000
  elif (("angler rod") or ("nightwave rod")) in inventory:
    fishtop = 10
  elif "fine fishing rod" in inventory:
    fishtop = 7
  elif "old fishing rod" in inventory:
    fishtop = 5
  else:
    fishtop = 1
  if weather == "rain":
  ...
  time.sleep(2)
  fishluck = random.randint(1, fishtop)
  if fishluck == 4:
    fishcaught = "salmon"
    print("You caught a " + fishcaught + "!")
    inventory.append("raw salmon")
  elif ((fishluck == 5) or (fishluck == 6)):
    fishcaught = "cod"
    print("You caught a " + fishcaught + "!")
    inventory.append("raw cod")
  elif ((fishluck == 7) or (fishluck == 8)):
    fishcaught = "catfish"
    print("You caught a " + fishcaught + "!")
    inventory.append("raw catfish")
  elif fishluck == 9:
    fishcaught = "bass"
    print("You caught a " + fishcaught + "!")
    inventory.append("raw bass")
  elif fishluck == 10:
    if "nightwave rod" in inventory:
      fishcaught = "voidfish"
      print("You caught a " + fishcaught + "!")
      inventory.append("raw voidfish")
    else:
      fishcaught = "platefish"
      print("You caught a " + fishcaught + "!")
      inventory.append("raw platefish")
  elif fishluck == 11:
      fishcaught = "platefish"
      print("You caught a " + fishcaught + "!")
      inventory.append("raw platefish")
    ...
    print("In the hour of fishing you spent, nothing bit at your line.")
  timeshift(1, 0)
  time.sleep(2)
  locationreturn()
